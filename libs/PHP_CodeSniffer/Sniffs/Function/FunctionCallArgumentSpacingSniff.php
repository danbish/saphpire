<?php
    /**
     * This sniff makes sure that arguments for function calls are spaced correctly.
     * Code is taken from Generic standards function call argument spacing sniff.
     */
    class PHP_CodeSniffer_Sniffs_Function_FunctionCallArgumentSpacingSniff implements PHP_CodeSniffer_Sniff
    {
        /**
