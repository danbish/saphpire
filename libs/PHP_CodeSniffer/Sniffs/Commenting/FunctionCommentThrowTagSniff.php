<?php
    /**
     * This sniff makes sure that functions that throw exceptions have the @throws Exception tag.
     * Code is taken from Squiz standards function comment throw tag sniff.
     */
    class PHP_CodeSniffer_Sniffs_Commenting_FunctionCommentThrowTagSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
    {
        /**
            ...
            if ($currScopeEnd !== 0) {
                while ($currPos < $currScopeEnd && $currPos !== false) {
                    ...
                    */
                    ...
                    if ($tokens[$nextToken]['code'] === T_NEW || $tokens[ $nextToken ][ 'content' ] === 'BubbleException' ) {
